<?php 
    ...
    $query = "select * from answerscripts";
...
<html>
  <head>
    ...
    <title>Add Answer Scripts-DPE</title>
...
<b>Hall Ticket No. :</b>&emsp;
<input type="text" name="HtNo">
<br><br>
        <input type="file" name="file" />
        <input type="submit" value="Upload" onclick="add()"/>
    </form>
<script>
function add(){
alert("File uploaded successfully.");
	document.location.href =  "addasnwerscripts.php";
}
</script>
</center>  
</body>
